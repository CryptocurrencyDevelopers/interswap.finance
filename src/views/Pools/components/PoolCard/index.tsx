...
const PoolCard: React.FC<{ pool: DeserializedPool; account: string }> = ({ pool, account }) => {
  ...
  const isCakePool = earningToken.address == '0x4ca6B6b8F10EB17DbD1f8c3F313Eca2F779C6e0B'
    ...
    >
      <PoolCardHeader isStaking={accountHasStakedBalance} isFinished={isFinished && sousId !== 0}>
        <PoolCardHeaderTitle
          ...
          subTitle={isCakePool ? t('Earn CRYSTAL, stake CRYSTAL') : t('Stake %symbol%', { symbol: stakingToken.symbol })}
        />
