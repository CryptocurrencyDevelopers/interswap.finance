...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and XSC pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and XSC pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from XSC pool', data)
  }
